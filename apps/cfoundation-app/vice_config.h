/* vice_config.h — c=foundation Xcode build configuration
 * Generated from VICE 3.9 ./configure run on macOS (arm64).
 * Hand-maintained for the Xcode target; update when VICE is upgraded.
 *
 * Original: src/config.h.  Generated from config.h.in by configure.
 */

/* c=foundation overrides: disable GTK3/SDL2 arch, enable native macOS */
#undef USE_GTK3UI
#undef USE_SDLUI
#undef USE_SDLUI2
...
#define CONFIGURE_FLAGS "--without-gtk3 --without-sdl2 --enable-native-tools"
